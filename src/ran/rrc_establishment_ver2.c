...
void handle_rrc_setup_request(rrc_setup_request_t* setup_request) {
    ...
    rrcSetup.radioBearerConfig.logicalChannelId = 3;  
    rrcSetup.radioBearerConfig.priority = 1;
    rrcSetup.radioBearerConfig.lcGroup = 0;
    rrcSetup.radioBearerConfig.pdcpConfig = 1;
